...
export const CALLS = [
  {
    ...
    choices: [
      ...
      },
      {
        text: 'Wrong number.',
        outcome:
          '"That\'s what they all say." Click. Something slides into your collection drawer.',
        sanityDelta: -3,
        staticMult: 1.5,
        tape: true,
        tapeName: 'Tape #1 — The Wrong Number',
      },
    ],
  },
  {
    ...
    choices: [
      {
        ...
        staticMult: 1.5,
        tape: true,
        tapeName: "Tape #2 — The Collector's Archive",
      },
      {
        text: 'No.',
    ...
    choices: [
      {
        ...
        staticMult: 2,
        tape: true,
        tapeName: "Tape #4 — Yesterday's Frequency",
      },
      {
  ...
  },
  {
    ...
    sanityDelta: 10,
    tape: true,
    tapeName: 'Tape #6 — Signal From Guardian',
    lines: [
  ...
  },
  {
    ...
    choices: [
      ...
      },
      {
        ...
        staticMult: 2,
        tape: true,
        tapeName: 'Tape #10 — Courtesy Call',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    sanityDelta: -30,
    tape: true,
    tapeName: 'Tape #13 — First Transmission',
    lines: [
