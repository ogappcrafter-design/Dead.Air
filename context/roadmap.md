...
- Add voice fragments + static textures per tape (PIX-4261): Band-appropriate voice fragments (whispers for LOST, murmurs for LIMINAL, static for CLASSIFIED, distortion for ████████), static textures vary by rarity
...
- Acceptance checks:
  ...
  - [ ] Band-appropriate content (whispers/murmurs/static/distortion)
...
- Build fragment libraries per band (PIX-4257): Create `data/fragments/<band>.ts` for 5 bands (LIVING, LIMINAL, LOST, CLASSIFIED, ████████), each with opening/middle/closing/response fragments
